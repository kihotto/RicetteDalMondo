  ...
  return (
    <ScrollView
      ...
      <View className="px-4 py-6">
        ...
        {/* Fasi */}
        <View className="mb-8 border-l-2 border-orange-600 pl-4">
        ...
        {/* Dev Team Bar */}
        <View className="mb-4 mt-4 rounded-lg bg-green-900 p-4">
...
// Componenti Helper
function LibraryItem({ name, version, description }: { name: string; version: string; description: string }) {
  return (
...
function StatItem({ label, value }: { label: string; value: string }) {
  return (
    <View className="flex-1 rounded-lg border border-orange-600 bg-neutral-900 p-3" style={{ minWidth: '40%' }}>
